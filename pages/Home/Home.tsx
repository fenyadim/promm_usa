    ...
    <div className={styles.wrapper}>
      ...
      <section className={styles.benefis_wrapper}>
        ...
        <div>
          ...
          <div className={styles.benefis_info}>
            ...
            <p className="main__benefits-description">
              We help you set up the equipment, provide extended warranty and quality service.
            </p>
          </div>
        </div>
        <div>
          ...
          <div className={styles.benefis_info}>
            ...
            <p className="main__benefits-description">
              Full support - from the purchase of equipment to connection to the pool and placement
      ...
      <section className={styles.company_wrapper}>
        <div className={styles.company_info}>
          <h2>About company</h2>
          <p>
            The company's work is based on constant development in the field of blockchain and
            cryptography. We bring modern technology into this world. That is why we make the field
            of mining available to everyone.
          </p>
          <div className={styles.company_achievement}>
            <div>
              ...
              <p className="company__left-description">
                The company occupies a leading position in the international market
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="company__left-description">ASIC miners delivered to our customers</p>
            </div>
            <div>
              <h3 className="company__left-heading">40 000 000 $</h3>
              <p className="company__left-description">Earned by our customers in 2022</p>
            </div>
          </div>
