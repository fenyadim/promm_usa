...
export const recallData: RecallType[] = [
  {
    ...
    date: '05.07.2023',
    name: 'Simon D',
    text: "Easy to deal with and us. Based I went with the priority shipping and had my order 2 days after I received the tracking and only 3 days total. Some places take a week to even provide tracking. I’ll be a return customer.",
  },
  {
  ...
  },
  {
    ...
    date: '18.06.2023',
    name: 'William A',
    text: "If this company I bought this model miner ipollo still now I am so satisfied and has low noise and Low power consumption , relay so fast shipping  with cheap price and cheap shipping 😱👌💸",
  },
  {
