...
export const products: DataType = {
  ...
  business: [
    {
      slug: 'ready-start',
      src: '/image/ready-business/START.png',
      title: 'Ready-made business-START',
      price: 6186000,
      availableCount: 1,
      containerMining: 36,
      income: 0.38,
    ...
    {
      slug: 'ready-smart',
      src: '/image/ready-business/SMART.png',
      title: 'Ready-made business-SMART',
      price: 6186000,
      availableCount: 1,
      containerMining: 120,
      income: 1.26,
    ...
    {
      slug: 'ready-medium',
      src: '/image/ready-business/MEDIUM.png',
      title: 'Ready-made business-MEDIUM',
      price: 6186000,
      availableCount: 1,
      containerMining: 192,
      income: 2.03,
    ...
    {
      slug: 'ready-big',
      src: '/image/ready-business/BIG.png',
      title: 'Ready-made business-BIG',
      price: 6186000,
      availableCount: 1,
      containerMining: 256,
      income: 2.8,
    ...
    {
      slug: 'ready-max',
      src: '/image/ready-business/MAX.png',
      title: 'Ready-made business-MAX',
      price: 6186000,
      availableCount: 1,
      containerMining: 300,
      income: 3.18,
    ...
    {
      slug: 'ready-vip',
      src: '/image/ready-business/VIP.png',
      title: 'Ready-made business-VIP',
      price: 6186000,
      availableCount: 1,
      containerMining: 456,
      income: 4.83,
    ...
    {
      slug: 'ready-moon',
      src: '/image/ready-business/TO THE MOON.png',
      title: 'Ready-made business-TO THE MOON',
      price: 6186000,
      availableCount: 1,
      containerMining: 2640,
      income: 28,
    },
    {
      slug: 'ready-standart',
      src: '/image/ready-business/STANDART.png',
      title: 'Ready-made business-STANDART',
      price: 6186000,
      availableCount: 1,
      containerMining: 72,
      income: 0.76,
    ...
    {
      slug: 'ready-lux',
      src: '/image/ready-business/LUX.png',
      title: 'Ready-made business-LUX',
      price: 6186000,
      availableCount: 1,
      containerMining: 792,
      income: 8.4,
