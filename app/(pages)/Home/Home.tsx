...
const Home: FC = () => {
	return (
		<div className={styles.wrapper}>
			...
			<section className={styles.benefis}>
				<div className={styles.benefis_wrapper}>
					...
					<div>
						...
						<div className={styles.benefis_info}>
							...
							<p className="main__benefits-description">
								Full support - from the purchase of equipment to connection to
								the pool and placement in their own data center.
							</p>
						</div>
					</div>
					<div>
			...
			<section className={styles.company}>
				<div className={styles.company_wrapper}>
					<div className={styles.company_info}>
						<h2>About company</h2>
						<p>
							The company's work is based on constant development in the field
							of blockchain and cryptography. We bring modern technology into
							this world. That is why we make the field of mining available to
							everyone.
						</p>
			...
			<section className={styles.bussiness}>
			...
			<section className={styles.turnkey}>
				<div className={styles.turnkey_wrapper}>
