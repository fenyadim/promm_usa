	...
	return (
		<section className="delivery">
			...
			<p className="delivery__description">
				...
				option. After the manager calls you and confirms the availability of the
				goods, you can come and pick up your order. Promminer is headquartered
				in Los Angeles at: 5261 W Imperial Hwy, Los Angeles, CA 90045, USA
			</p>
			<h3 className="section__heading">UPS shipping</h3>
			<p className="delivery__description">
				Shipping by shipping company is a popular shipping option in the United
				States. This method involves using a third-party shipping company for
				the shipment. The delivery is made to the nearest delivery point in your
				city or to the address specified by you.
			</p>
