...
const Privacy: FC = () => {
	return (
		<section className={styles.privacy_container}>
			<div>
				<h2>SHIPPING & RETURN POLICY</h2>
				<p>
					Thank you for your purchase. We hope you are happy with your purchase.
					However, if there is something wrong with your purchase, you may file
					a return/exchange request. Please see below for more information on
					our return policy.
				</p>
				<h3>SHIPPING</h3>
				<p>
					Promminer.us is committed to bring our products to everyone in the
					world. Our service delivers to most countries in the world and is
					dedicated to meeting a variety of shipping needs.
					<br />
					<br />
					Once the payment has been received in full and such has been confirmed
					by Promminer, please allow up to two days of processing time.
					Processing time depends on which location of ours is shipping the
					order.
					<br />
					Once the order is processed and shipped, please allow 2-5 business
					days for delivery. Delivery times are calculated by carrier and
					shipping method.
					<br />A tracking number will be shared with you via your preferred
					means of communication.
					<br />
					<br />
					Our responsibility of the condition of product will cease once the
					product has been handed over to the carrier. In case of any damage
					claims, you will need to contact the carrier directly. In case the
					shipment is returned to us and is considered 'Undeliverable' for any
					reason, we will make arrangements to ship it to you again. Please note
					that any additional fees or charges incurred in this process will be
					passed back to you. For added protection, you may choose to purchase
					insurance from the carrier at your own discretion.
					<br />
					<br />
					*All sales will appear as Promminer on your billing statement.
				</p>
				<h3>RETURNS</h3>
				<ul>
					<li> - Damage in Transit</li>
					<p>
						If any items were damaged in transit, we ask that you report it to
						us within three (3) days. If the items are visibly damaged on
						receipt, please refuse the delivery and contact us as soon as
						possible. Items should be returned in their original packaging
						complete with all accessories and documentation. Once the return
						item received in our warehouse, we’ll issue a replacement unit.
					</p>
					<li> - Item Missing or Incorrect</li>
					<p>
						Item If there is an item missing from your order or the wrong item
						has been sent, please contact us within three (3) days, and we will
				...
				<p>
					...
					us at: support@promminer.us
				</p>
			</div>
			<div>
				<h2>ABOUT COMPANY</h2>
				<p>
					Promminer is a subsidiary of Promminer LTD Dubai/Promminer Hong Kong
					founded by a group of enthusiasts who are miners themselves. The
					management team has mined and worked in the crypto mining industry
					with years of experience and has developed extensive relationships
					with mainstream and reputable crypto equipment manufacturers. With the
					recent migration of hash rate to North America, the United States is
					now the epicenter of crypto mining. Promminer is formed here locally
					in sunny southern California to serve our global clients with
					integrity and top-notch customer service.
					<br />
					<br />
					We are not only a distributor for major mining equipment but also
					source used miners and crypto farm equipment like transformers and
					containers. We are currently working on assisting our clients with
					their hosting needs as well. Under our mission statement of sourcing
					the best profit returns on crypto mining investments, we strive to be
					your one-stop shop for all your crypto mining needs, help you to
					acquire worry-free passive income, and contribute back to the
					community.
					<br />
					<br />
					We look forward to doing business and growing with you.
				</p>
			</div>
			<div>
				...
				<p>
					...
					Promminer ("Company", “we”, “us”, or “our”), concerning your access to
					and use of Promminer.us (“The Site”) as well as any other media form,
					...
					registered in 5261 W Imperial Hwy, Los Angeles, CA 90045, USA. You
					...
					are at least 18 years of age. All users who are minors in the
				...
				<p>
					We accept the following forms of payment: Crypto Bank Transfer You
					...
					can complete your transactions and contact you as needed. Sales tax
					...
					or Cryptos with equal value. You are responsible for all custom duty,
					import tax or sales tax on all applicable products if there is any. We
					will help our customer to optimize shipping related expenses. Our
					product prices are subject to change based on market condition, we
					reserve the right to cancel orders or refuse services on rare
					circumstances. We reserve the right to refuse any order placed through
					the Site. We may, in our sole discretion, limit or cancel quantities
					...
					or distributors. We may require you to make deposits or advance
					payments for certain Products, which we may use to satisfy your
					initial bill for an Order, or to offset against any unpaid balance on
					your account, or as otherwise set forth in these Terms, or as
					permitted by law. Interest will not be paid on advance payments or
					deposits unless required by law. We may require additional advance
					payments or deposits if we determine that the initial payment was
					inadequate. Based on your creditworthiness or for other reasons, we
					may establish limits and restrict provision of Products or features as
					we deem appropriate.
				</p>
				<h3>7. SHIPMENT AND DELIVERY</h3>
				<p>
					The Products will be delivered within a reasonable time after the date
					of an order, subject to availability of finished Products. We shall
					not be liable for any delays, loss or damage in transit. We will use
					standard methods for packaging and shipping Products. All prices for
					shipping are EXW, Incoterms® 2020. If for any reason Customer fails to
					accept delivery of any of the Products, or if we are unable to deliver
					the Products because Customer has not provided appropriate
					instructions, documents, licenses or authorizations: (i) risk of loss
					to the Products shall pass to Customer; (ii) the Products shall be
					deemed to have been delivered; and (iii) we, at its option, may store
					the Products until Customer picks them up, whereupon Customer shall be
					liable for all related costs and expenses (including, without
					limitation, storage and insurance).
				</p>
				<h3>8. RETURN/REFUNDS POLICY</h3>
				<p>
					All sales are final and no refund will be issued. Please see Return
				...
				<p>
					...
					for any revenue-generating endeavor or commercial enterprise. Use the
					Site to advertise or offer to sell goods and services. Sell or
					otherwise transfer your profile.
				</p>
				<h3>10. USER GENERATED CONTENTS</h3>
				<p>
					...
					any manner contemplated by the Site and these Terms of Use. You have
					...
					contemplated by the Site and these Terms of Use. Your Contributions
					...
					Terms of Use, or any applicable law or regulation. Any use of the Site
					or the Marketplace Offerings in violation of the foregoing violates
					these Terms of Use and may result in, among other things, termination
					or suspension of your rights to use the Site and the Marketplace
					Offerings.
				</p>
				<h3>11. CONTRIBUTION LICENSE</h3>
				<p>
				...
				<p>
					...
					do so at your own risk, and you should be aware these Terms of Use no
				...
				<p>
					...
					Policy. By using the Site or the Marketplace Offerings, you agree to
				...
				<p>
					...
					Offerings. We cannot guarantee the Site and the Marketplace Offerings
					will be available at all times. We may experience hardware, software,
					...
					Site or the Marketplace Offerings at any time or for any reason
					...
					access or use the Site or the Marketplace Offerings during any
					downtime or discontinuance of the Site or the Marketplace Offerings.
				...
				<p>
					...
					Orange County, California, and the Parties hereby consent to, and
				...
				<h3>23. LIMITATIONS OF LIABILITY</h3>
				<p>
				...
				<h3>26. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>
				<p>
				...
				<h3>28. CONTACT</h3>
				<p>
					US In order to resolve a complaint regarding the Site or to receive
					further information regarding use of the Site, please contact us at:
					Promminer us 5261 W Imperial Hwy, Los Angeles, CA 90045, USA
